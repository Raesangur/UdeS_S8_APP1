...
DesignFiles="-v93 " + DESIGN_ROOT + "/sqrt_conv.vhd"
DesignFiles+=" -v93 " + DESIGN_ROOT + "/uart_rx.vhd"
DesignFiles+=" -v93 " + DESIGN_ROOT + "/uart_tx.vhd"
DesignFiles+=" -v93 " + DESIGN_ROOT + "/topvhdl.vhd"

DesignFiles += " -sv " + DESIGN_ROOT + "/top.sv"
Models= ""
TestbenchFiles= ""
...
def test_start():
    ...
    run(
        ...
        compile_args=[DesignFiles, AssertionFiles, CoverageCommands],
