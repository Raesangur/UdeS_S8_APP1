...
async def cocotbext_uart_demo(dut):
    ...
    SomeValue = build_command_message(0, 9, 0)
    #cocotb.binary.BinaryValue(value=0x000900000000, n_bits=48, bigEndian=False)
    ...
    crc_sending = cocotb.binary.BinaryValue(value=crc_val, n_bits=8, bigEndian=False)
...
# L1.E4 function to wait for response message
