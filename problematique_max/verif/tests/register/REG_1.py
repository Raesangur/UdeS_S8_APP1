...
# Test REG.1: Read Register 0x9 and receive 0xBADEFACE
@cocotb.test()
async def REG_1(dut):
    print("REG.1: Read Register 0x9 and receive 0xBADEFACE")
...
async def REG_1(dut):
    ...
    # Generate Product Version ID Register Adress Value:
    #SomeValue = cocotb.binary.BinaryValue(value=0x1023456789ABDCEF, n_bits=64, bigEndian=False)
    SomeValue = build_command_message(0, 0x9, 0)
